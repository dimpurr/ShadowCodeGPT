...
import {
    workspace as Workspace, window as Window, ExtensionContext, TextDocument, WorkspaceFolder, Uri, OutputChannel
} from 'vscode';
...
export function setupLanguageClient(context: ExtensionContext, outputChannel: OutputChannel) {
